...
<template>
  ...
  >
    <template v-if="formData" #body>
      <div :class="formData.serveStatus == 5 ? 'grey' : ''" class="status pd">
        <span v-if="formData.serveStatus === 0" class="tag">待分配</span>
        <span v-if="formData.serveStatus === 1" class="tag">待上门</span>
        <span v-if="formData.serveStatus === 2" class="tag">待完工</span>
        <span v-if="formData.serveStatus === 3" class="tag">已完成</span>
        <span v-if="formData.serveStatus === 4" class="tag">已取消</span>
        <span v-if="formData.serveStatus === 5" class="tag">被退单</span>
        <span v-if="formData.serveStatus === 1" class="content"
        >请在
          {{
      ...
      <div :class="isShowShadow ? 'shadow' : ''" class="body scollHeight">
        ...
        <!-- end -->
        <!-- 退款信息 -->
        <div v-if="formData.serveStatus === 4" class="card">
        ...
        >
          ...
          <div class="rightBox">
            ...
            <div v-if="formData.serveStatus === 3" class="lineBox">
              <div class="serviceBox">
      ...
      <div v-if="formData.serveStatus !== 3 && listName !== 'historyList'" class="footBox">
        <div
