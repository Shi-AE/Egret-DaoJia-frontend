            ...
            <view class="uni-list-chat__container">
                <view class="uni-list-chat__header-warp">
                    <view v-if="avatarCircle || avatarList.length === 0" :class="{ 'header--circle': avatarCircle }"
                        ...
                        <image :class="{ 'header--circle': avatarCircle }" :src="avatar"
                               class="uni-list-chat__header-image" mode="aspectFill"></image>
                    </view>
                    <!-- 头像组 -->
                    <view v-else class="uni-list-chat__header">
                        <view v-for="(item, index) in avatarList" :key="index" :class="computedAvatar"
                            ...
                            <image :src="item.url"
                                   :style="{ width: imageWidth + 'px', height: imageWidth + 'px' }" class="uni-list-chat__header-image"
                ...
                <view class="uni-list-chat__content">
                    ...
                    <view class="uni-list-chat__content-extra">
                        <slot>
                            ...
                            <view v-if="badgeText && badgePositon === 'right'" :class="[isSingle, badgePositon === 'right' ? 'uni-list-chat--right' : '']"
