<template>
    ...
    <view class="uni-swipe">
        ...
        <view :change:prop="wxsswipe.showWatch" :data-disabled="disabled"
              :data-threshold="threshold" :prop="is_show" class="uni-swipe_box" @touchend="wxsswipe.touchend"
              @touchmove="wxsswipe.touchmove" @touchstart="wxsswipe.touchstart">
            <!-- #endif -->
            <!--  #ifndef MP-WEIXIN || VUE3 -->
            <view :change:prop="renderswipe.showWatch" :data-disabled="disabled+''"
                  :data-threshold="threshold" :prop="is_show" class="uni-swipe_box"
                  @touchend="renderswipe.touchend" @touchmove="renderswipe.touchmove"
                ...
                <view class="uni-swipe_button-group button-group--left">
                    <slot name="left">
					  ...
					  backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD'
                            ...
                            <text :style="{color: item.style && item.style.color ? item.style.color : '#FFFFFF',fontSize: item.style && item.style.fontSize ? item.style.fontSize : '16px'}"
        ...
        <view ref="selector-box--hock" class="uni-swipe" @horizontalpan="touchstart" @touchend="touchend">
            <view ref='selector-left-button--hock' class="uni-swipe_button-group button-group--left">
                <slot name="left">
                    <view v-for="(item,index) in leftOptions" :key="index" :data-button="btn" :style="{
				  backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD'
            ...
            <view ref='selector-right-button--hock' class="uni-swipe_button-group button-group--right">
                <slot name="right">
                    <view v-for="(item,index) in rightOptions" :key="index" :data-button="btn" :style="{
				  backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD'
