<template>
    <view class="uni-calendar" @mouseleave="leaveCale">
        <view v-if="!insert&&show" :class="{'uni-calendar--mask-show':aniMaskShow}" class="uni-calendar__mask"
              @click="clean"></view>
        <view v-if="insert || show" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow, 'uni-calendar__content-mobile': aniMaskShow}"
            ...
            <view v-if="!insert && !range && typeHasTime" class="uni-date-changed uni-calendar--fixed-top"
                ...
                <time-picker v-model="time" :border="false" :disabled="!tempSingleDate" :end="reactEndTime"
                             :hide-second="hideSecond" :start="reactStartTime" class="time-picker-style"
                             type="time">
                </time-picker>
            </view>
            ...
            <view v-if="!insert && range && typeHasTime" class="uni-date-changed uni-calendar--fixed-top">
                <view class="uni-date-changed--time-start">
                    ...
                    <time-picker v-model="timeRange.startTime" :border="false" :disabled="!tempRange.before" :hide-second="hideSecond"
