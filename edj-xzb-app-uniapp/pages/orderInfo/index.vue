      ...
      "
        ...
        <view class="customerInfo card">
            ...
            <view class="nameAndPhone">
                ...
                >{{ info.data.customerInfo.contactsPhone }}
                </text
                >
            </view>
            <view class="address">
        ...
        <!-- 取消信息 -->
        <view v-if="info.data.serveStatus === 4" class="orderInfo card">
        ...
        >
            ...
            >{{ info.data.serveStatus === 1 ? '开始服务' : '完成服务' }}
            </view
            >
            <view
        ...
        <!-- 提示窗示例 -->
        <uni-popup ref="alertDialog" :is-mask-click="false" type="bottom">
