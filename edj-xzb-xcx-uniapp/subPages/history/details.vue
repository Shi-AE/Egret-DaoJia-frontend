    ...
    <scroll-view class="scroll-view-content" scroll-y>
        <view class="pageCon detailsBox">
            ...
            <view>
                ...
                <view class="box projectBox">
                    <view class="projectInfo">
                        ...
                        <view class="rText">
                            ...
                            <view class="projectFee">
                                <text class="hour"
                                >{{ baseData.orderInfo?.serveItemName }} × {{
                                        baseData.orderInfo?.purNum
                                    }}{{ UNIT[baseData.orderInfo?.unit - 1]?.label }}
                                </text
                                >
                            </view>
                    ...
                    >{{
                        ...
                        >¥{{ baseData.orderInfo?.realPayAmount }}
                        </text
                        >
                    </view
                    >
            ...
            "
              ...
              "
                        ...
                        <view class="item">
                            ...
                            <view class="two"
                            >
                                <text>{{ baseData.orderInfo?.contactsName }}
                                </text
                                >
                                <text>{{ baseData.orderInfo?.contactsPhone }}</text>
                            </view
                            >
                        </view>
                    </view>
                    ...
                    >
                        ...
                        <view v-if="baseData.orderInfo?.ordersStatus === 700" class="item"
                        >
                            <text>退款金额</text>
                            <view>{{
            ...
            "
                        class="orderList"
                    >
                        <view v-if="baseData.orderInfo?.serverName" class="item"
                        >
                            <text>服务人员</text>
                            <view>{{ baseData.orderInfo?.serverName }}</view>
                        </view>
                        <view v-if="baseData.orderInfo?.serveActualEndTime" class="item"
                        >
                            <text>完成时间</text>
                            <view>{{
                                    formatDateTimeToDateTimeString(
                    ...
                    <view class="orderList">
                        ...
                        <view v-if="baseData.orderInfo?.createTime" class="item"
                        >
                            <text>下单时间</text>
                            <view>{{
                                    formatDateTimeToDateTimeString(
