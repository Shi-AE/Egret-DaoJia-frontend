...
<template>
  <scroll-view class="scroll-view-content" scroll-y>
    <view class="pageCon detailsBox">
          ...
          <view class="projectInfo">
            ...
            <view class="rText">
              ...
              <view class="projectFee">
                <text class="hour"
                >{{ baseData.serveItemName }} × {{
                    baseData.purNum
                  }}{{ UNIT[baseData.unit - 1]?.label }}
                </text
                >
              </view>
        ...
        <view class="mt-20 box orderInfo">
          ...
          >
            ...
            <view class="item">
              ...
              <view class="two"
              >
                <text>{{ baseData.contactsName }}
                </text
                >
                <text>{{ baseData.contactsPhone }}</text>
              </view
              >
            </view>
          </view>
          ...
          >
            ...
            <view v-if="baseData.ordersStatus === 700" class="item"
            >
              <text>退款金额</text>
              <view>{{
          ...
          <view
            ...
            class="orderList"
          >
            <view v-if="baseData.serverName" class="item"
            >
              <text>服务人员</text>
              <view>{{ baseData.serverName }}</view>
            </view>
            <view v-if="baseData.serveActualEndTime" class="item"
            >
              <text>完成时间</text>
              <view>{{
                  formatDateTimeToDateTimeString(
          ...
          <view class="orderList">
            ...
            <view v-if="baseData.createTime" class="item"
            >
              <text>下单时间</text>
              <view>{{
                  formatDateTimeToDateTimeString(
      ...
      <view v-if="baseData.ordersStatus !== 300" class="footBox detailFoot"
      >
        <view
          v-if="
            baseData.ordersStatus === 0 ||
