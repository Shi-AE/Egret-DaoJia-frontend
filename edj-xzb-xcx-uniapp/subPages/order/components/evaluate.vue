...
<template>
    <view :class="edit ? 'evaluate' : 'bg-wt evaluate appList'">
        <NavBar
            ...
            :title="title"
        ></NavBar>
        <view v-if="edit" class="evaluationBox">
            <view class="head">
          ...
          "
            ...
            color: '#151515',
                ...
                <view class="textNum">
                    <!-- 表情 -->
                    <Emoji :id="1" @handleEmoji1="handleEmoji1"></Emoji>
                    <text
        ...
        <!-- 师傅评价 -->
        <view v-if="edit" class="evaluationBox shifu">
            <view class="head">
          ...
          "
            ...
            color: '#151515',
                ...
                <view class="textNum">
                    <!-- 表情 -->
                    <Emoji :id="2" @handleEmoji2="handleEmoji2"></Emoji>
                    <text
        ...
        <view v-if="edit" class="anonymous">
        ...
        <view v-if="!edit" class="evaluationBox">
            <view class="successBox">
                ...
                <button class="agree-btn btn" @click="toComments">查看评价</button>
            </view>
        </view>
        <view v-if="edit" class="pageFixFoot">
            <button class="agree-btn btn" @click="toSubmit">确认提交</button>
        </view>
        <!-- 分割线 -->
        ...
        <scroll-view
            ...
            scroll-y="true"
        >
            <view v-if="!edit && itemData.length > 0" class="orderList">
