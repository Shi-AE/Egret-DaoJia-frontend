<template>
  <view>
    <NavBar :isShowBack="true" title="选择服务地址"></NavBar>
    ...
    >
      <view v-if="disPosition" id="hot">
        ...
        <view class="position">
          ...
          <view class="position_city">
            ...
            <view class="WarpWeft" @click="getWarpWeft">
              <image mode="scaleToFill" src="../../static/cxdw@2x.png" />
              <text>{{ po_tips }}</text>
            </view>
          </view>
        </view>
        <!-- 最近模块 -->
        <!-- 热门 -->
        <view v-if="hotCity.length > 0" class="position">
    ...
    <!-- end -->
    <!-- 选中之后字母 -->
    <view v-if="touchmove" class="mask">
