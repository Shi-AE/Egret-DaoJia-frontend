    ...
    <view>
        ...
        <view class="tabScroll">
            <view class="itemTab box">
                <view :class="activeIndex === '' ? 'active' : ''" class="tabBox">
                    <view
                ...
                <scroll-view scroll-y="true">
                  ...
                  item.remainNum <= 0 && item.remainNum !== null
                    ...
                    : '',
                            ...
                            >
                                <view class="price">
                                    <text v-if="item.type === 1" class="unit">￥</text>
                                    <text class="money"
                                    >{{
                                        item.type === 1
                                    ...
                                    <text v-if="item.type === 2" class="unit">折</text>
                                </view>
                                <view
                    ...
                    >
                        <uni-load-more :content-text="contentText" :status="moreStatus"
                        />
                    </view>
                    <!-- end -->
                </scroll-view>
