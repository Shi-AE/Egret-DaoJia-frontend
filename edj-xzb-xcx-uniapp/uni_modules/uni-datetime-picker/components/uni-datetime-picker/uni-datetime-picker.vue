    ...
    <view class="uni-date">
		...
		'uni-date-x--border': border}" class="uni-date-editor--x">
                    <view v-if="!isRange" class="uni-date-x uni-date-single">
                        <uni-icons color="#e1e1e1" size="22" type="calendar"></uni-icons>
                    ...
                    <view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear">
                        <uni-icons color="#e1e1e1" size="18" type="clear"></uni-icons>
                    </view>
                </view>
            </slot>
        </view>
            ...
            <view v-if="!isRange" :style="popover" class="uni-date-single--x">
                ...
                <view v-if="hasTime" class="uni-date-changed popup-x-header">
                    ...
                    <time-picker v-model="time" :border="false" :disabled="!tempSingleDate" :end="reactEndTime"
                                 :hideSecond="hideSecond" :start="reactStartTime" style="width: 100%;"
                                 type="time">
            ...
            <view v-else :style="popover" class="uni-date-range--x">
                ...
                <view v-if="hasTime" class="popup-x-header uni-date-changed">
                    <view class="popup-x-header--datetime">
                        <input v-model="tempRange.startDate" :placeholder="startDateText" class="uni-date__input uni-date-range__input"
                               type="text"/>
                        <time-picker v-model="tempRange.startTime" :border="false" :disabled="!tempRange.startDate" :hideSecond="hideSecond"
        ...
        <calendar v-show="isPhone" ref="mobile" :clearDate="false" :date="defSingleDate" :defTime="reactMobDefTime"
                  ...
                  :typeHasTime="hasTime" @confirm="mobileChange"/>
    </view>
</template>
<script>
/**
